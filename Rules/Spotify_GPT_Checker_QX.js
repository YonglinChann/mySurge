...
const arrow = " ➟ ";
var netflix = "Netflix: 未检测";
var ytb = "YouTube Premium: 未检测";
var gpt = "ChatGPT: 未检测";
var spotify = "Spotify: 未检测";
  ...
  return new (class {
    ...
    runScript(t, e) {
      return new Promise((s) => {
        ...
        this.post(n, (t, e, a) => s(a)).catch((t) => this.logErr(t));
      });
    }
    loaddata() {
        ...
        default:
          this.isSurge() &&
            ...
            $httpClient.get(t, (t, s, a) => {
              !t &&
                s &&
                ((s.body = a), (s.statusCode = s.status ? s.status : s.statusCode), (s.status = s.statusCode)),
                e(t, s, a);
            });
          break;
        case "Quantumult X":
    ...
    wait(t) {
      ...
      switch (
        (this.log("", `🔔${this.name}, 结束! 🕛 ${e} 秒`), this.log(), this.getEnv())
      ) {
        case "Surge":
        case "Loon":
        case "Stash":
